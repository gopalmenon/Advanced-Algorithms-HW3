...
There cannot be a chain that ends at Bob's side with Alice not having any of the opportunities listed above in a case where perfect matching does not exist. So Alice always has a winning strategy.
